...
function peg$parse(input, options) {
  ...
  const peg$e60 = peg$otherExpectation("RENAME TO Keyword");
  const peg$e61 = peg$otherExpectation("ADD COLUMN Keyword");
  const peg$e62 = peg$otherExpectation("Common Table Expression");
  const peg$e63 = peg$otherExpectation("ATTACH Statement");
  const peg$e64 = peg$otherExpectation("DETACH Statement");
  const peg$e65 = peg$otherExpectation("VACUUM Statement");
  const peg$e66 = peg$otherExpectation("ANALYZE Statement");
  const peg$e67 = peg$otherExpectation("REINDEX Statement");
  const peg$e68 = peg$otherExpectation("PRAGMA Statement");
  const peg$e69 = peg$otherExpectation("SELECT Statement");
  const peg$e70 = peg$otherExpectation("ORDER BY Clause");
  const peg$e71 = peg$otherExpectation("LIMIT Clause");
  const peg$e72 = peg$otherExpectation("OFFSET Clause");
  const peg$e73 = peg$otherExpectation("Union Operation");
  const peg$e74 = peg$otherExpectation("SELECT Results Clause");
  const peg$e75 = peg$otherExpectation("SELECT Results Modifier");
  const peg$e76 = peg$otherExpectation("FROM Clause");
  const peg$e77 = peg$otherExpectation("WHERE Clause");
  const peg$e78 = peg$otherExpectation("RETURNING Clause");
  const peg$e79 = peg$otherExpectation("GROUP BY Clause");
  const peg$e80 = peg$otherExpectation("HAVING Clause");
  const peg$e81 = peg$otherExpectation("CROSS JOIN Operation");
  const peg$e82 = peg$otherExpectation("JOIN Operation");
  const peg$e83 = peg$otherExpectation("Qualified Table");
  const peg$e84 = peg$otherExpectation("Qualified Table Identifier");
  const peg$e85 = peg$otherExpectation("Qualfied Table Index");
  const peg$e86 = peg$otherExpectation("SELECT Source");
  const peg$e87 = peg$otherExpectation("Subquery");
  const peg$e88 = peg$otherExpectation("Alias");
  const peg$e89 = peg$otherExpectation("JOIN Operator");
  const peg$e90 = peg$otherExpectation("JOIN Constraint");
  const peg$e91 = peg$otherExpectation("Join ON Clause");
  const peg$e92 = peg$otherExpectation("Join USING Clause");
  const peg$e93 = peg$otherExpectation("VALUES Clause");
  const peg$e94 = peg$otherExpectation("Ordering Expression");
  const peg$e95 = peg$otherExpectation("Star");
  const peg$e96 = peg$otherExpectation("Fallback Type");
  const peg$e97 = peg$otherExpectation("INSERT Statement");
  const peg$e98 = peg$otherExpectation("INSERT Keyword");
  const peg$e99 = peg$otherExpectation("REPLACE Keyword");
  const peg$e100 = peg$otherExpectation("INSERT OR Modifier");
  const peg$e101 = peg$otherExpectation("INTO Clause");
  const peg$e102 = peg$otherExpectation("INTO Keyword");
  const peg$e103 = peg$otherExpectation("Column List");
  const peg$e104 = peg$otherExpectation("Column Name");
  const peg$e105 = peg$otherExpectation("VALUES Keyword");
  const peg$e106 = peg$otherExpectation("Wrapped Expression List");
  const peg$e107 = peg$otherExpectation("DEFAULT VALUES Clause");
  const peg$e108 = peg$otherExpectation("Compound Operator");
  const peg$e109 = peg$otherExpectation("UNION Operator");
  const peg$e110 = peg$otherExpectation("UPDATE Statement");
  const peg$e111 = peg$otherExpectation("UPDATE Keyword");
  const peg$e112 = peg$otherExpectation("UPDATE OR Modifier");
  const peg$e113 = peg$otherExpectation("SET Clause");
  const peg$e114 = peg$otherExpectation("Column Assignment");
  const peg$e115 = peg$otherExpectation("DELETE Statement");
  const peg$e116 = peg$otherExpectation("DELETE Keyword");
  const peg$e117 = peg$otherExpectation("CREATE Statement");
  const peg$e118 = peg$otherExpectation("CREATE TABLE Statement");
  const peg$e119 = peg$otherExpectation("IF NOT EXISTS Modifier");
  const peg$e120 = peg$otherExpectation("Table Definition");
  const peg$e121 = peg$otherExpectation("Column Definition");
  const peg$e122 = peg$otherExpectation("Column Datatype");
  const peg$e123 = peg$otherExpectation("Column Constraint");
  const peg$e124 = peg$otherExpectation("CONSTRAINT Name");
  const peg$e125 = peg$otherExpectation("FOREIGN KEY Column Constraint");
  const peg$e126 = peg$otherExpectation("PRIMARY KEY Column Constraint");
  const peg$e127 = peg$otherExpectation("PRIMARY KEY Keyword");
  const peg$e128 = peg$otherExpectation("AUTOINCREMENT Keyword");
  const peg$e129 = peg$otherExpectation("UNIQUE Column Constraint");
  const peg$e130 = peg$otherExpectation("NULL Column Constraint");
  const peg$e131 = peg$otherExpectation("CHECK Column Constraint");
  const peg$e132 = peg$otherExpectation("DEFAULT Column Constraint");
  const peg$e133 = peg$otherExpectation("COLLATE Column Constraint");
  const peg$e134 = peg$otherExpectation("Table Constraint");
  const peg$e135 = peg$otherExpectation("CHECK Table Constraint");
  const peg$e136 = peg$otherExpectation("PRIMARY KEY Table Constraint");
  const peg$e137 = peg$otherExpectation("UNIQUE Keyword");
  const peg$e138 = peg$otherExpectation("Indexed Column");
  const peg$e139 = peg$otherExpectation("Collation");
  const peg$e140 = peg$otherExpectation("Column Direction");
  const peg$e141 = peg$otherExpectation("ON CONFLICT Keyword");
  const peg$e142 = peg$otherExpectation("FOREIGN KEY Table Constraint");
  const peg$e143 = peg$otherExpectation("FOREIGN KEY Keyword");
  const peg$e144 = peg$otherExpectation("REFERENCES Clause");
  const peg$e145 = peg$otherExpectation("FOREIGN KEY Action Clause");
  const peg$e146 = peg$otherExpectation("FOREIGN KEY Action");
  const peg$e147 = peg$otherExpectation("DEFERRABLE Clause");
  const peg$e148 = peg$otherExpectation("CREATE INDEX Statement");
  const peg$e149 = peg$otherExpectation("ON Clause");
  const peg$e150 = peg$otherExpectation("CREATE TRIGGER Statement");
  const peg$e151 = peg$otherExpectation("Conditional Clause");
  const peg$e152 = peg$otherExpectation("Conditional Action");
  const peg$e153 = peg$literalExpectation("STATEMENT", true);
  const peg$e154 = peg$otherExpectation("Actions Clause");
  const peg$e155 = peg$otherExpectation("CREATE VIEW Statement");
  const peg$e156 = peg$otherExpectation("CREATE VIRTUAL TABLE Statement");
  const peg$e157 = peg$otherExpectation("Module Arguments");
  const peg$e158 = peg$otherExpectation("DROP Statement");
  const peg$e159 = peg$otherExpectation("DROP Keyword");
  const peg$e160 = peg$otherExpectation("DROP Type");
  const peg$e161 = peg$otherExpectation("IF EXISTS Keyword");
  const peg$e162 = peg$otherExpectation("Or");
  const peg$e163 = peg$otherExpectation("Add");
  const peg$e164 = peg$otherExpectation("Subtract");
  const peg$e165 = peg$otherExpectation("Multiply");
  const peg$e166 = peg$otherExpectation("Divide");
  const peg$e167 = peg$otherExpectation("Modulo");
  const peg$e168 = peg$otherExpectation("Shift Left");
  const peg$e169 = peg$otherExpectation("Shift Right");
  const peg$e170 = peg$otherExpectation("Logical AND");
  const peg$e171 = peg$otherExpectation("Logical OR");
  const peg$e172 = peg$otherExpectation("Less Than");
  const peg$e173 = peg$otherExpectation("Greater Than");
  const peg$e174 = peg$otherExpectation("Less Than Or Equal");
  const peg$e175 = peg$otherExpectation("Greater Than Or Equal");
  const peg$e176 = peg$otherExpectation("Equal");
  const peg$e177 = peg$otherExpectation("Not Equal");
  const peg$e178 = peg$otherExpectation("IS");
  const peg$e179 = peg$otherExpectation("Identifier");
  const peg$e180 = peg$otherExpectation("Database Identifier");
  const peg$e181 = peg$otherExpectation("Function Identifier");
  const peg$e182 = peg$otherExpectation("Table Identifier");
  const peg$e183 = peg$otherExpectation("Column Identifier");
  const peg$e184 = peg$otherExpectation("Collation Identifier");
  const peg$e185 = peg$otherExpectation("Savepoint Identifier");
  const peg$e186 = peg$otherExpectation("Index Identifier");
  const peg$e187 = peg$otherExpectation("Trigger Identifier");
  const peg$e188 = peg$otherExpectation("View Identifier");
  const peg$e189 = peg$otherExpectation("Pragma Identifier");
  const peg$e190 = peg$otherExpectation("CTE Identifier");
  const peg$e191 = peg$otherExpectation("Datatype Name");
  const peg$e192 = peg$otherExpectation("TEXT Datatype Name");
  const peg$e193 = peg$literalExpectation("N", true);
  const peg$e194 = peg$literalExpectation("VAR", true);
  const peg$e195 = peg$literalExpectation("CHAR", true);
  const peg$e196 = peg$literalExpectation("TINY", true);
  const peg$e197 = peg$literalExpectation("MEDIUM", true);
  const peg$e198 = peg$literalExpectation("LONG", true);
  const peg$e199 = peg$literalExpectation("TEXT", true);
  const peg$e200 = peg$literalExpectation("CLOB", true);
  const peg$e201 = peg$otherExpectation("REAL Datatype Name");
  const peg$e202 = peg$literalExpectation("FLOAT", true);
  const peg$e203 = peg$literalExpectation("REAL", true);
  const peg$e204 = peg$otherExpectation("DOUBLE Datatype Name");
  const peg$e205 = peg$literalExpectation("DOUBLE", true);
  const peg$e206 = peg$literalExpectation("PRECISION", true);
  const peg$e207 = peg$otherExpectation("NUMERIC Datatype Name");
  const peg$e208 = peg$literalExpectation("NUMERIC", true);
  const peg$e209 = peg$literalExpectation("DECIMAL", true);
  const peg$e210 = peg$literalExpectation("BOOLEAN", true);
  const peg$e211 = peg$literalExpectation("DATE", true);
  const peg$e212 = peg$literalExpectation("TIME", true);
  const peg$e213 = peg$literalExpectation("STAMP", true);
  const peg$e214 = peg$literalExpectation("STRING", true);
  const peg$e215 = peg$otherExpectation("INTEGER Datatype Name");
  const peg$e216 = peg$literalExpectation("INT", true);
  const peg$e217 = peg$classExpectation(["2", "4", "8"], false, false, false);
  const peg$e218 = peg$literalExpectation("EGER", true);
  const peg$e219 = peg$literalExpectation("BIG", true);
  const peg$e220 = peg$literalExpectation("SMALL", true);
  const peg$e221 = peg$literalExpectation("FLOATING", true);
  const peg$e222 = peg$literalExpectation("POINT", true);
  const peg$e223 = peg$otherExpectation("BLOB Datatype Name");
  const peg$e224 = peg$literalExpectation("BLOB", true);
  const peg$e225 = peg$classExpectation([["a", "z"], ["0", "9"], "$", "_"], false, true, false);
  const peg$e226 = peg$literalExpectation("\\u", false);
  const peg$e227 = peg$classExpectation([["a", "f"], ["0", "9"]], false, true, false);
  const peg$e228 = peg$anyExpectation();
  const peg$e229 = peg$classExpectation([" ", "\t"], false, false, false);
  const peg$e230 = peg$literalExpectation("\"", false);
  const peg$e231 = peg$literalExpectation("\"\"", false);
  const peg$e232 = peg$classExpectation(["\""], true, false, false);
  ...
  const peg$e236 = peg$classExpectation(["`"], true, false, false);
  const peg$e237 = peg$otherExpectation("Open Bracket");
  const peg$e238 = peg$literalExpectation("[", false);
  const peg$e239 = peg$otherExpectation("Close Bracket");
  const peg$e240 = peg$literalExpectation("]", false);
  const peg$e241 = peg$otherExpectation("Open Parenthesis");
  const peg$e242 = peg$literalExpectation("(", false);
  const peg$e243 = peg$otherExpectation("Close Parenthesis");
  const peg$e244 = peg$literalExpectation(")", false);
  const peg$e245 = peg$otherExpectation("Comma");
  const peg$e246 = peg$literalExpectation(",", false);
  const peg$e247 = peg$otherExpectation("Period");
  const peg$e248 = peg$literalExpectation(".", false);
  const peg$e249 = peg$otherExpectation("Asterisk");
  const peg$e250 = peg$literalExpectation("*", false);
  const peg$e251 = peg$otherExpectation("Question Mark");
  const peg$e252 = peg$literalExpectation("?", false);
  const peg$e253 = peg$otherExpectation("Single Quote");
  const peg$e254 = peg$otherExpectation("Tilde");
  const peg$e255 = peg$literalExpectation("~", false);
  const peg$e256 = peg$otherExpectation("Plus");
  const peg$e257 = peg$literalExpectation("+", false);
  const peg$e258 = peg$otherExpectation("Minus");
  const peg$e259 = peg$literalExpectation("-", false);
  const peg$e260 = peg$literalExpectation("=", false);
  const peg$e261 = peg$otherExpectation("Ampersand");
  const peg$e262 = peg$literalExpectation("&", false);
  const peg$e263 = peg$otherExpectation("Pipe");
  ...
  const peg$e268 = peg$otherExpectation("Exclamation");
  const peg$e269 = peg$literalExpectation("!", false);
  const peg$e270 = peg$otherExpectation("Semicolon");
  const peg$e271 = peg$literalExpectation(";", false);
  const peg$e272 = peg$otherExpectation("Forward Slash");
  const peg$e273 = peg$literalExpectation("/", false);
  const peg$e274 = peg$literalExpectation("ABORT", true);
  const peg$e275 = peg$literalExpectation("ACTION", true);
  const peg$e276 = peg$literalExpectation("ADD", true);
  const peg$e277 = peg$literalExpectation("AFTER", true);
  const peg$e278 = peg$literalExpectation("ALL", true);
  const peg$e279 = peg$literalExpectation("ALTER", true);
  const peg$e280 = peg$literalExpectation("ANALYZE", true);
  const peg$e281 = peg$literalExpectation("AND", true);
  const peg$e282 = peg$literalExpectation("AS", true);
  const peg$e283 = peg$literalExpectation("ASC", true);
  const peg$e284 = peg$literalExpectation("ATTACH", true);
  const peg$e285 = peg$literalExpectation("AUTOINCREMENT", true);
  const peg$e286 = peg$literalExpectation("BEFORE", true);
  const peg$e287 = peg$literalExpectation("BEGIN", true);
  const peg$e288 = peg$literalExpectation("BETWEEN", true);
  const peg$e289 = peg$literalExpectation("BY", true);
  const peg$e290 = peg$literalExpectation("CASCADE", true);
  const peg$e291 = peg$literalExpectation("CASE", true);
  const peg$e292 = peg$literalExpectation("CAST", true);
  const peg$e293 = peg$literalExpectation("CHECK", true);
  const peg$e294 = peg$literalExpectation("COLLATE", true);
  const peg$e295 = peg$literalExpectation("COLUMN", true);
  const peg$e296 = peg$literalExpectation("COMMIT", true);
  const peg$e297 = peg$literalExpectation("CONFLICT", true);
  const peg$e298 = peg$literalExpectation("CONSTRAINT", true);
  const peg$e299 = peg$literalExpectation("CREATE", true);
  const peg$e300 = peg$literalExpectation("CROSS", true);
  const peg$e301 = peg$literalExpectation("CURRENT_DATE", true);
  const peg$e302 = peg$literalExpectation("CURRENT_TIME", true);
  const peg$e303 = peg$literalExpectation("CURRENT_TIMESTAMP", true);
  const peg$e304 = peg$literalExpectation("DATABASE", true);
  const peg$e305 = peg$literalExpectation("DEFAULT", true);
  const peg$e306 = peg$literalExpectation("DEFERRABLE", true);
  const peg$e307 = peg$literalExpectation("DEFERRED", true);
  const peg$e308 = peg$literalExpectation("DELETE", true);
  const peg$e309 = peg$literalExpectation("DESC", true);
  const peg$e310 = peg$literalExpectation("DETACH", true);
  const peg$e311 = peg$literalExpectation("DISTINCT", true);
  const peg$e312 = peg$literalExpectation("DROP", true);
  const peg$e313 = peg$literalExpectation("EACH", true);
  const peg$e314 = peg$literalExpectation("ELSE", true);
  const peg$e315 = peg$literalExpectation("END", true);
  const peg$e316 = peg$literalExpectation("ESCAPE", true);
  const peg$e317 = peg$literalExpectation("EXCEPT", true);
  const peg$e318 = peg$literalExpectation("EXCLUSIVE", true);
  const peg$e319 = peg$literalExpectation("EXISTS", true);
  const peg$e320 = peg$literalExpectation("EXPLAIN", true);
  const peg$e321 = peg$literalExpectation("FAIL", true);
  const peg$e322 = peg$literalExpectation("FOR", true);
  const peg$e323 = peg$literalExpectation("FOREIGN", true);
  const peg$e324 = peg$literalExpectation("FROM", true);
  const peg$e325 = peg$literalExpectation("FULL", true);
  const peg$e326 = peg$literalExpectation("GLOB", true);
  const peg$e327 = peg$literalExpectation("GROUP", true);
  const peg$e328 = peg$literalExpectation("HAVING", true);
  const peg$e329 = peg$literalExpectation("IF", true);
  const peg$e330 = peg$literalExpectation("IGNORE", true);
  const peg$e331 = peg$literalExpectation("IMMEDIATE", true);
  const peg$e332 = peg$literalExpectation("IN", true);
  const peg$e333 = peg$literalExpectation("INDEX", true);
  const peg$e334 = peg$literalExpectation("INDEXED", true);
  const peg$e335 = peg$literalExpectation("INITIALLY", true);
  const peg$e336 = peg$literalExpectation("INNER", true);
  const peg$e337 = peg$literalExpectation("INSERT", true);
  const peg$e338 = peg$literalExpectation("INSTEAD", true);
  const peg$e339 = peg$literalExpectation("INTERSECT", true);
  const peg$e340 = peg$literalExpectation("INTO", true);
  const peg$e341 = peg$literalExpectation("IS", true);
  const peg$e342 = peg$literalExpectation("ISNULL", true);
  const peg$e343 = peg$literalExpectation("JOIN", true);
  const peg$e344 = peg$literalExpectation("KEY", true);
  const peg$e345 = peg$literalExpectation("LEFT", true);
  const peg$e346 = peg$literalExpectation("LIKE", true);
  const peg$e347 = peg$literalExpectation("LIMIT", true);
  const peg$e348 = peg$literalExpectation("MATCH", true);
  const peg$e349 = peg$literalExpectation("NATURAL", true);
  const peg$e350 = peg$literalExpectation("NO", true);
  const peg$e351 = peg$literalExpectation("NOT", true);
  const peg$e352 = peg$literalExpectation("NOTNULL", true);
  const peg$e353 = peg$literalExpectation("OF", true);
  const peg$e354 = peg$literalExpectation("OFFSET", true);
  const peg$e355 = peg$literalExpectation("ON", true);
  const peg$e356 = peg$literalExpectation("OR", true);
  const peg$e357 = peg$literalExpectation("ORDER", true);
  const peg$e358 = peg$literalExpectation("OUTER", true);
  const peg$e359 = peg$literalExpectation("PLAN", true);
  const peg$e360 = peg$literalExpectation("PRAGMA", true);
  const peg$e361 = peg$literalExpectation("PRIMARY", true);
  const peg$e362 = peg$literalExpectation("QUERY", true);
  const peg$e363 = peg$literalExpectation("RAISE", true);
  const peg$e364 = peg$literalExpectation("RECURSIVE", true);
  const peg$e365 = peg$literalExpectation("REFERENCES", true);
  const peg$e366 = peg$literalExpectation("REGEXP", true);
  const peg$e367 = peg$literalExpectation("REINDEX", true);
  const peg$e368 = peg$literalExpectation("RELEASE", true);
  const peg$e369 = peg$literalExpectation("RENAME", true);
  const peg$e370 = peg$literalExpectation("REPLACE", true);
  const peg$e371 = peg$literalExpectation("RESTRICT", true);
  const peg$e372 = peg$literalExpectation("RETURNING", true);
  const peg$e373 = peg$literalExpectation("RIGHT", true);
  const peg$e374 = peg$literalExpectation("ROLLBACK", true);
  const peg$e375 = peg$literalExpectation("ROW", true);
  const peg$e376 = peg$literalExpectation("ROWID", true);
  const peg$e377 = peg$literalExpectation("SAVEPOINT", true);
  const peg$e378 = peg$literalExpectation("SELECT", true);
  const peg$e379 = peg$literalExpectation("SET", true);
  const peg$e380 = peg$literalExpectation("TABLE", true);
  const peg$e381 = peg$literalExpectation("TEMP", true);
  const peg$e382 = peg$literalExpectation("TEMPORARY", true);
  const peg$e383 = peg$literalExpectation("THEN", true);
  const peg$e384 = peg$literalExpectation("TO", true);
  const peg$e385 = peg$literalExpectation("TRANSACTION", true);
  const peg$e386 = peg$literalExpectation("TRIGGER", true);
  const peg$e387 = peg$literalExpectation("UNION", true);
  const peg$e388 = peg$literalExpectation("UNIQUE", true);
  const peg$e389 = peg$literalExpectation("UPDATE", true);
  const peg$e390 = peg$literalExpectation("USING", true);
  const peg$e391 = peg$literalExpectation("VACUUM", true);
  const peg$e392 = peg$literalExpectation("VALUES", true);
  const peg$e393 = peg$literalExpectation("VIEW", true);
  const peg$e394 = peg$literalExpectation("VIRTUAL", true);
  const peg$e395 = peg$literalExpectation("WHEN", true);
  const peg$e396 = peg$literalExpectation("WHERE", true);
  const peg$e397 = peg$literalExpectation("WITH", true);
  const peg$e398 = peg$literalExpectation("WITHOUT", true);
  const peg$e399 = peg$otherExpectation("Line Comment");
  const peg$e400 = peg$literalExpectation("--", false);
  const peg$e401 = peg$classExpectation(["\n", "\v", "\f", "\r"], false, false, false);
  const peg$e402 = peg$otherExpectation("Block Comment");
  const peg$e403 = peg$literalExpectation("/*", false);
  const peg$e404 = peg$literalExpectation("*/", false);
  const peg$e405 = peg$classExpectation(["\n", "\v", "\f", "\r", "\t", " "], false, false, false);
  ...
  function peg$f88(s, n) {
    return {
      'action': keyNode(s),
      'name': n
    };
  }
  function peg$f89(s, d) {
    return {
      'action': keyNode(s),
      'definition': d
    };
  }
  function peg$f90(s) {    return keyNode(s);  }
  function peg$f91(w, s) {    return Object.assign(s, w);  }
  function peg$f92(w) {
    return w;
  }
  function peg$f93(s, v, t) {
    var recursive = {
  ...
  function peg$f94(s) {    return keyNode(s);  }
  function peg$f95(f, r) {    return flattenAll([ f, r ]);  }
  function peg$f96(e) {    return e;  }
  function peg$f97(t, s) {
    return Object.assign({
      'type': 'expression',
      'format': 'table',
      'variant': 'common',
  ...
  function peg$f100(w, s) {
    return Object.assign(s, w);
  }
  function peg$f101(a, b, e, n) {
    return {
      'type': 'statement',
      'variant': keyNode(a),
      'target': n,
  ...
  function peg$f110(v) {    return v;  }
  function peg$f111(v) {    return v;  }
  function peg$f112(v) {    return /^(yes|no|on|off|false|true|0|1)$/i.test(v)  }
  function peg$f113(v) {
    return {
      'type': 'literal',
      'variant': 'boolean',
  ...
  function peg$f119(o, e) {
    return {
      'offset': e
    };
  }
  function peg$f120(s) {    return keyNode(s);  }
  function peg$f121(s, u) {
    if (isArrayOkay(u)) {
      return {
        'type': 'statement',
        'variant': 'compound',
  ...
  function peg$f123(s, f, w, g) {
    return Object.assign({
      'type': 'statement',
      'variant': 'select',
    }, s, f, w, g);
  }
  function peg$f124(d, t) {
    return Object.assign({
      'result': t
    }, d);
  }
  ...
  function peg$f127(f, r) {    return flattenAll([ f, r ]);  }
  function peg$f128(n) {    return n;  }
  function peg$f129(f, s) {
    return {
      'from': s
    };
  }
  function peg$f130(f, e) {
    return {
      'where': makeArray(e)
    };
  }
  function peg$f131(f, t) {
    return {
      'returning': t
    };
  }
  function peg$f132(f, r) {    return flattenAll([ f, r ]);  }
  function peg$f133(n) {    return n;  }
  function peg$f134(s) {
    return {
      'type': 'identifier',
      'variant': 'star',
  ...
  function peg$f135(e, a) {
    return Object.assign(e, a);
  }
  function peg$f136(f, e, h) {
    return Object.assign({
      'group': e
    }, h);
  }
  function peg$f137(f, e) {
    return {
      'having': e
    };
  }
  function peg$f138(q, s) {
    return {
      'type': 'identifier',
      'variant': 'star',
  ...
  function peg$f139(n, s) {    return foldStringWord([ n, s ]);  }
  function peg$f140(e, a) {
    return Object.assign(e, a);
  }
  function peg$f141(f, t) {
    if (isArrayOkay(t)) {
      return {
        'type': 'map',
        'variant': 'join',
  ...
  function peg$f146(d, i) {
    return Object.assign(d, i);
  }
  function peg$f147(n, a) {
    return Object.assign(n, a);
  }
  function peg$f148(s, n) {
    return {
      'index': n
    };
  }
  function peg$f149(n, i) {
    // TODO: Not sure what should happen here
    return {
      'index': foldStringKey([ n, i ])
    };
  }
  function peg$f150(l, a) {    return Object.assign(l, a);  }
  function peg$f151(s, a) {
    return Object.assign(s, a);
  }
  function peg$f152(a, n) {
    return {
      'alias': n
    };
  }
  function peg$f153(n, t, j) {    return foldStringKey([ n, t, j ]);  }
  function peg$f154(n) {    return keyNode(n);  }
  function peg$f155(t, o) {    return foldStringKey([ t, o ]);  }
  function peg$f156(t) {    return keyNode(t);  }
  ...
  function peg$f162(f, b) {
    return {
      'result': flattenAll([ f, b ])
    };
  }
  function peg$f163(i) {    return i;  }
  function peg$f164(e, d) {
  ...
  function peg$f165(k, t, ret) {
    return Object.assign({
      'type': 'statement',
      'variant': 'insert'
    }, k, t, ret);
  }
  function peg$f166(a, m) {
    return Object.assign({
      'action': keyNode(a)
    }, m);
  }
  ...
  function peg$f168(s, m) {
    return {
      'or': keyNode(m)
    };
  }
  function peg$f169(i, r) {
    return Object.assign({
      'into': i
    }, r);
  }
  function peg$f170(s, t) {
    return t;
  }
  function peg$f171(r) {
    return {
  ...
  function peg$f172(f, b) {
    return {
      'columns': flattenAll([ f, b ])
    };
  }
  function peg$f173(c) {    return c;  }
  function peg$f174(n) {
    return {
      'type': 'identifier',
      'variant': 'column',
  ...
  function peg$f175(s, r) {    return r;  }
  function peg$f176(s) {    return keyNode(s);  }
  function peg$f177(f, b) {    return flattenAll([ f, b ]);  }
  function peg$f178(e) {    return e;  }
  function peg$f179(e) {
    return e;
  }
  function peg$f180(d, v) {
    return {
      'type': 'values',
      'variant': 'default'
  ...
  function peg$f181(s) {    return keyNode(s);  }
  function peg$f182(s, a) {    return foldStringKey([ s, a ]);  }
  function peg$f183(a) {    return a;  }
  function peg$f184(s, f, t, u, w, o, l, ret) {
    return Object.assign({
      'type': 'statement',
      'variant': s,
      'into': t
  ...
  function peg$f185(s) {    return keyNode(s);  }
  function peg$f186(t) {
    return {
      'or': keyNode(t)
    };
  ...
  function peg$f188(f, b) {    return flattenAll([ f, b ]);  }
  function peg$f189(c) {    return c;  }
  function peg$f190(f, e) {
    return {
      'type': 'assignment',
      'target': f,
      'value': e
  ...
  function peg$f191(s, t, w, o, l, ret) {
    return Object.assign({
      'type': 'statement',
      'variant': s,
      'from': t
  ...
  function peg$f192(s) {    return keyNode(s);  }
  ...
  function peg$f199(s, ne, id, r) {
    return Object.assign({
      'type': 'statement',
      'name': id
    }, s, r, ne);
  }
  function peg$f200(s, tmp, t) {
    return Object.assign({
      'variant': s,
      'format': keyNode(t)
    }, tmp);
  ...
  function peg$f203(s, t, r) {
    return Object.assign({
      'definition': flattenAll([ s, t ])
    }, r);
  }
  function peg$f204(r, w) {
    return {
      'optimization': [{
        'type': 'optimization',
  ...
  function peg$f205(f, b) {    return flattenAll([ f, b ]);  }
  function peg$f206(t) {    return t;  }
  function peg$f207(f) {    return f;  }
  function peg$f208(n, t, c) {
    return Object.assign({
      'type': 'definition',
      'variant': 'column',
      'name': n,
  ...
  function peg$f212(f, b) {    return flattenAll([ f, b ]);  }
  function peg$f213(c) {    return c;  }
  function peg$f214(n, c, ln) {
    return Object.assign(c, n);
  }
  function peg$f215(cl) {
  ...
  function peg$f218(p, d, c, a) {
    return Object.assign(p, c, d, a);
  }
  function peg$f219(s, k) {
    return {
      'type': 'constraint',
  ...
  function peg$f221(s, c) {
    return Object.assign({
      'type': 'constraint',
      'variant': s
    }, c);
  }
  function peg$f222(t) {    return keyNode(t);  }
  function peg$f223(n, l) {    return foldStringKey([ n, l ]);  }
  function peg$f224(s, v) {
    return {
      'type': 'constraint',
      'variant': keyNode(s),
      'value': v
  ...
  function peg$f230(p, k) {    return foldStringKey([ p, k ]);  }
  function peg$f231(u) {    return keyNode(u);  }
  function peg$f232(f, b) {
    return [f].concat(b);
  }
  function peg$f233(c) {
  ...
  function peg$f235(c) {    return c;  }
  function peg$f236(e, d, a) {
    // Only convert this into an ordering expression if it contains
    // more than just the expression.
    let res = e;
    if (isOkay(d)) {
  ...
  function peg$f241(s, t) {
    return {
      'conflict': keyNode(t)
    };
  }
  function peg$f242(o, c) {    return foldStringKey([ o, c ]);  }
  function peg$f243(k, c) {
    return {
      'type': 'constraint',
      'variant': keyNode(k),
      'expression': c
  ...
  function peg$f244(k, l, c) {
    return Object.assign({
      'definition': makeArray(Object.assign(k, c))
    }, l);
  }
  function peg$f245(f, k) {
    return {
      'type': 'constraint',
      'variant': foldStringKey([ f, k ])
    };
  }
  function peg$f246(r, a, d) {
    return Object.assign({
      'type': 'constraint'
    }, r, a, d);
  }
  function peg$f247(s, t) {
    return {
      'references': t
    };
  }
  function peg$f248(f, b) {
    return {
      'action': flattenAll([ f, b ])
    };
  }
  function peg$f249(a) {    return a;  }
  function peg$f250(m, a, n) {
    return {
      'type': 'action',
      'variant': keyNode(m),
      'action': keyNode(n)
  ...
  function peg$f251(s, v) {    return foldStringKey([ s, v ]);  }
  function peg$f252(c) {    return keyNode(c);  }
  function peg$f253(n, a) {    return foldStringKey([ n, a ]);  }
  function peg$f254(m, n) {
    return {
      'type': 'action',
      'variant': keyNode(m),
      'action': n
  ...
  function peg$f255(n, d, i) {
    return {
      'defer': foldStringKey([ n, d, i ])
    };
  }
  function peg$f256(i, d) {    return foldStringKey([ i, d ]);  }
  function peg$f257(s) {
    return {
      'definition': makeArray(s)
    };
  }
  function peg$f258(s, ne, n, o, w) {
    return Object.assign({
      'type': 'statement',
      'target': n,
      'on': o,
  ...
  function peg$f262(s, ne, n, cd, o, me, wh, a) {
    return Object.assign({
      'type': 'statement',
      'target': n,
      'on': o,
  ...
  function peg$f263(s, tmp, t) {
    return Object.assign({
      'variant': keyNode(s),
      'format': keyNode(t)
    }, tmp);
  }
  function peg$f264(m, d) {
    return Object.assign({
      'type': 'event'
    }, m, d);
  }
  ...
  function peg$f266(i, o) {    return foldStringKey([ i, o ]);  }
  function peg$f267(o) {
    return {
      'event': keyNode(o)
    };
  }
  function peg$f268(s, f) {
    return {
      'event': keyNode(s),
      'of': f
    };
  }
  function peg$f269(s, c) {    return c;  }
  function peg$f270(f, b) {    return flattenAll([ f, b ]);  }
  function peg$f271(f, e, r) {    return keyNode(r);  }
  function peg$f272(w, e) {
    return {
      'when': e
    };
  }
  function peg$f273(s, a, e) {    return a;  }
  function peg$f274(l) {    return l;  }
  function peg$f275(s) {    return s;  }
  function peg$f276(s, ne, n, r) {
    return Object.assign({
      'type': 'statement',
      'target': n,
      'result': r
  ...
  function peg$f278(s, tmp, v) {
    return Object.assign({
      'variant': keyNode(s),
      'format': keyNode(v)
    }, tmp);
  }
  function peg$f279(s, r) {    return r;  }
  function peg$f280(s, ne, n, m) {
    return Object.assign({
      'type': 'statement',
      'target': n,
      'result': m
  ...
  function peg$f281(s, v, t) {
    return {
      'variant': keyNode(s),
      'format': keyNode(v)
    };
  }
  function peg$f282(m, a) {
    return Object.assign({
      'type': 'module',
      'variant': 'virtual',
      'name': m
  ...
  function peg$f290(t) {    return keyNode(t);  }
  function peg$f291(i, e) {
    return {
      'condition': [{
        'type': 'condition',
        'variant': keyNode(i),
  ...
  function peg$f292(i, n) {    return foldStringKey([ i, n ]);  }
  function peg$f293(n) {
    return {
      'type': 'identifier',
      'variant': 'database',
  ...
  function peg$f296(n, d) {    return foldStringWord([ n, d ]);  }
  function peg$f297(q, n) {
    return {
      'type': 'identifier',
      'variant': 'column',
  ...
  function peg$f298() {    return '';  }
  function peg$f299(d, t) {    return foldStringWord([ d, t ]);  }
  function peg$f300(t, d) {    return foldStringWord([ t, d ]);  }
  function peg$f301(n) {
    return {
      'type': 'identifier',
      'variant': 'collation',
  ...
  function peg$f309(t) {    return [t, 'text'];  }
  function peg$f310(t) {    return [t, 'real'];  }
  function peg$f311(t) {    return [t, 'numeric'];  }
  function peg$f312(t) {    return [t, 'integer'];  }
  function peg$f313(t) {    return [t, 'none'];  }
  function peg$f314(t) {    return keyNode(t);  }
  function peg$f315(t) {    return keyNode(t);  }
  function peg$f316(d, p) {    return foldStringWord([ d, p ]);  }
  function peg$f317(t) {    return keyNode(t);  }
  function peg$f318(t) {    return keyNode(t);  }
  function peg$f319(f, p) {
    return foldStringWord([ f, p ]);
  }
  function peg$f320(t) {    return keyNode(t);  }
  function peg$f321(u, s) {
  ...
  function peg$f349(r) {    return keyNode(r);  }
  function peg$f350() {    return null;  }
  function peg$f351(n) {    return n;  }
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          ...
          peg$savedPos = s0;
          s0 = peg$f184(s1, s2, s3, s5, s6, s7, s9, s10);
        } else {
          peg$currPos = s0;
          s0 = peg$FAILED;
        }
      ...
      if (s5 !== peg$FAILED) {
        ...
        if (s6 !== peg$FAILED) {
          ...
          if (s8 !== peg$FAILED) {
            ...
            if (s12 !== peg$FAILED) {
              peg$savedPos = s0;
              s0 = peg$f262(s1, s2, s3, s5, s8, s10, s11, s12);
            } else {
              peg$currPos = s0;
              s0 = peg$FAILED;
            }
